...
def load_and_prepare_data_for_scanorama():
    """
    Loads and preprocesses data, then splits it by batch for Scanorama.
    This function includes normalization, log transformation, variable gene detection, and scaling.
    """
    try:
...
def main():
    ...
    # --- FIX: Calling the correct, newly defined function ---
    ...
    # Re-assign the original celltype labels in the correct order
    adata.obs[CELLTYPE_KEY] = true_labels_full.values
    ...
    plot_metrics_bar(ari, rand, silhouette, "Scanorama_Algorithm_With_BBKNN_data")
    save_metrics_csv(ari, rand, silhouette, "CSV_Scanorama_Algorithm_With_BBKNN_data")
